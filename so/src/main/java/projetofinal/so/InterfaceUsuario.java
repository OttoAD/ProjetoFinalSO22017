...
public class InterfaceUsuario {
    ...
    public static void main( String[] args ){
    	...
    	try {
			...
			System.out.println("Tempo de inicializacao do processo 1: "+lis.getProcessoPorIdentificador(0).getTempoInicializacao());
			System.out.println("Tempo de processador do processo 2: "+lis.getProcessoPorIdentificador(1).getTempoProcessador());
